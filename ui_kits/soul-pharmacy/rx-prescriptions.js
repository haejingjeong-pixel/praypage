  ...
  "anxious": {
    ...
    "B": [
      ...
      },
      {
        ...
        "verse": "공중의 새를 보라 심지도 않고 거두지도 않고 창고에 모아 들이지도 아니하되 너희 천부께서 기르시나니 너희는 이것들보다 귀하지 아니하냐 너희 중에 누가 염려함으로 그 키를 한 자나 더할 수 있느냐",
  ...
  "thanks": {
    ...
    "B": [
      ...
      },
      {
        ...
        "opinion": "지친 마음에는 감사하는 일조차 새로운 과제가 될 수 있습니다. 하지만 목자는 지친 양에게 먼저 더 멀리 걸으라고 요구하지 않습니다. 푸른 초장에 눕게 하고 쉴만한 물 가으로 인도하며, 약해진 생명이 다시 힘을 얻도록 돌봅니다. 지금 당신에게도 감사의 수행보다 영혼이 소생되는 시간이 먼저 필요할 수 있습니다.\n\n하나님은 당신이 회복 과제를 잘 수행했기 때문에 사랑하시는 분이 아닙니다. 아무것도 적지 못하고, 말씀을 오래 읽지 못하고, 가만히 누워 있는 시간에도 하나님께서 주신 생명의 가치는 줄어들지 않습니다. 하나님은 멈추어 있는 것처럼 보이는 시간에도 당신을 돌보며 다시 살아갈 힘을 준비하십니다.",
  ...
  "broken": {
    "A": [
      ...
      },
      {
        ...
        "reference": "미가 7:8",
        "verse": "나의 대적이여 나로 인하여 기뻐하지 말찌어다 나는 엎드러질찌라도 일어날 것이요 어두운데 앉을찌라도 여호와께서 나의 빛이 되실 것임이로다",
        "cognitive": "넘어졌으니 끝났다",
  ...
  "compare": {
    "A": [
      ...
      },
      {
        ...
        "reference": "이사야 43:4",
        "verse": "내가 너를 보배롭고 존귀하게 여기고 너를 사랑하였은즉 내가 사람들을 주어 너를 바꾸며 백성들로 네 생명을 대신하리니",
    ...
    "B": [
      {
        ...
        "verse": "주께서 내 장부를 지으시며 나의 모태에서 나를 조직하셨나이다 내가 주께 감사하옴은 나를 지으심이 신묘막측하심이라 주의 행사가 기이함을 내 영혼이 잘 아나이다",
        ...
        "practice": "‘나는 신묘막측하게 지어진 사람이다’라는 문장을 천천히 한 번 읽어보세요. 지금은 그 말을 믿으려 애쓰기보다 그냥 들려주기만 해도 괜찮습니다."
      },
      {
        "num": "B.2",
        ...
        "opinion": "당신은 자신을 미워하고 싶었던 것이 아니라, 더 괜찮은 사람이 되고 싶어 오래 자신을 살펴왔을 수 있어요. 하지만 비교가 반복되며 고치려던 시선이 존재 전체를 판단하는 시선으로 바뀌었을 수 있습니다. 하나님은 장점을 증명하라고 요구하지 않으십니다. 부족함과 상처가 남아 있는 지금도 당신을 자신이 지으신 존재로 바라보십니다.",
        "dose": "자책이 올라올 때 비교가 붙인 평가와 하나님께서 바라보시는 나를 구분해보세요. “하나님, 비교가 붙인 이름보다 저를 주님이 지으신 존재로 바라보시는 시선을 먼저 받아들이게 해주세요.”",
      ...
      },
      {
        ...
        "reference": "스바냐 3:17",
        "verse": "너의 하나님 여호와가 너의 가운데 계시니 그는 구원을 베푸실 전능자시라 그가 너로 인하여 기쁨을 이기지 못하여 하시며 너를 잠잠히 사랑하시며 너로 인하여 즐거이 부르며 기뻐하시리라 하리라",
